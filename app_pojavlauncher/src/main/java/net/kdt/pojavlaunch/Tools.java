...
import static org.tablewalk.PojavProfile.getAllProfiles;
import static org.tablewalk.prefs.LauncherPreferences.PREF_IGNORE_NOTCH;
import static org.tablewalk.prefs.LauncherPreferences.PREF_NOTCH_SIZE;
...
import org.tablewalk.lifecycle.ContextExecutorTask;
import org.tablewalk.lifecycle.LifecycleAwareAlertDialog;
import org.tablewalk.memory.MemoryHoleFinder;
import org.tablewalk.memory.SelfMapsParser;
...
import org.tablewalk.utils.OldVersionsUtils;
